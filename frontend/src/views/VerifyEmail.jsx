...
const VerifyEmail = ({ onBackToLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e1a] via-[#111827] to-[#1a2942] flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="bg-[#1a2942] rounded-2xl shadow-2xl p-6 sm:p-8 border border-[#1E40AF]">
          {/* Header */}
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            {estado === 'verificando' && (
              <>
                <Loader2 className="w-12 h-12 sm:w-16 sm:h-16 text-[#00BFFF] animate-spin" />
            ...
            {estado === 'error' && (
              <>
                ...
                <div className="text-center space-y-3 w-full">
                  <p className="text-lg sm:text-xl font-bold text-white">Error de Verificación</p>
                  ...
                  <div className="flex flex-col space-y-2 sm:space-y-3 mt-4 sm:mt-6 w-full px-2">
                    <button
                      ...
                      className="flex items-center justify-center space-x-2 bg-[#00BFFF] hover:bg-[#0099CC] text-[#0a0e1a] font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 text-sm sm:text-base"
                    >
                      {enviandoDeNuevo ? (
